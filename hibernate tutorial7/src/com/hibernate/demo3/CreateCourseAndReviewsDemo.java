...
try {
	...
	//add reviews to that course
	    tempcourse.addreview(new Review("Great javacourse"));
	    tempcourse.addreview(new Review("worst!!!!!!!!!!!!!!!!!"));
	    tempcourse.addreview(new Review("good practicals"));
	    //saving the course
